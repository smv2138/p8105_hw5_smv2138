...
The average estimated my across tests where the null hypothesis was rejected did not equal the true value of mu until the true value approached approximately 4. When the true mu was less than 4, the estimated mu was larger among the rejected tests was larger than the estimated mu among all tests (except when the true mu was 0, there were some estimated means in the rejected tests that were below the true mu value). 
